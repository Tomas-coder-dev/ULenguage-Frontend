...
// Helper for pretty Google category
    ...
    try {
      final uri = Uri.parse(
        query == null || query.isEmpty
            ? 'http://192.168.100.7:5000/api/explorer'
            : 'http://192.168.100.7:5000/api/explorer?query=${Uri.encodeComponent(query)}',
      );
                ...
                CupertinoButton(
                  ...
                  child: const Row(
                    children: [
                      ...
                      SizedBox(width: 7),
                      Text("Volver",
                          style: TextStyle(color: Color(0xFFDA2C38))),
                    ],
                  ),
                ),
              ],
